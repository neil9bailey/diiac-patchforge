...
| VendorLens network vendor intelligence | Local validated, Azure pending | Vendor catalogue, config-aware applicability, source-bound advisory ingest foundations, Ask PatchForge SRA/AIP chat, VendorLens UI, signed-pack artefacts, and DOCX/PDF report sections passed local validation. Azure rollout and live UI validation are pending. |
