...
const ROUTE_ROLES = [
  ...
  { method: "POST", pattern: /^\/api\/patchforge\/decision-packs\/[^/]+\/approvals$/, roles: ["PatchForge.SecurityLead", "PatchForge.CABApprover", "PatchForge.Admin"] },
  { method: "POST", pattern: /^\/api\/patchforge\/risk-acceptances$/, roles: ["PatchForge.RiskOwner", "PatchForge.SecurityLead", "PatchForge.Admin"] },
  { method: "POST", pattern: /^\/api\/patchforge\/risk-acceptances\/[^/]+\/review$/, roles: ["PatchForge.SecurityLead", "PatchForge.Admin"] },
  { method: "POST", pattern: /^\/api\/patchforge\/compensating-controls$/, roles: ["PatchForge.TriageAnalyst", "PatchForge.SecurityLead", "PatchForge.Admin"] },
  { method: "POST", pattern: /^\/api\/patchforge\/compensating-controls\/[^/]+\/review$/, roles: ["PatchForge.SecurityLead", "PatchForge.Admin"] },
  { method: "GET", pattern: /^\/api\/patchforge\/webhooks$/, roles: ["PatchForge.Admin", "PatchForge.Auditor"] },
  { method: "POST", pattern: /^\/api\/patchforge\/webhooks$/, roles: ["PatchForge.Admin"] },
  { method: "DELETE", pattern: /^\/api\/patchforge\/webhooks\/[^/]+$/, roles: ["PatchForge.Admin"] },
