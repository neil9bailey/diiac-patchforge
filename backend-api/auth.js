...
const ROUTE_ROLES = [
  ...
  { method: "POST", pattern: /^\/api\/patchforge\/admin\/uat-cleanup$/, roles: ["PatchForge.Admin"] },
  ...
  { method: "POST", pattern: /^\/api\/patchforge\/vulnerabilities\/[^/]+\/evidence$/, roles: ["PatchForge.TriageAnalyst", "PatchForge.SecurityLead", "PatchForge.ServiceOwner", "PatchForge.Admin"] },
  { method: "POST", pattern: /^\/api\/patchforge\/vulnerabilities\/[^/]+\/evidence\/[^/]+\/review$/, roles: ["PatchForge.SecurityLead", "PatchForge.ServiceOwner", "PatchForge.CABApprover", "PatchForge.RiskOwner", "PatchForge.Admin"] },
  { method: "POST", pattern: /^\/api\/patchforge\/vulnerabilities\/[^/]+\/evidence\/[^/]+\/reopen$/, roles: ["PatchForge.SecurityLead", "PatchForge.ServiceOwner", "PatchForge.CABApprover", "PatchForge.RiskOwner", "PatchForge.Admin"] },
